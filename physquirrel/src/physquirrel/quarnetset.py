...
class DenseQuarnetSet(QuarnetSet):
    ...
    def consistency(self, quarnetset, triangles=True, reticulations=True, weighted=True):
    ...
    def consistency_prime(self, quarnetset, reference, triangles=True, reticulations=True, weighted=True):
    ...
    def distance(self, quarnetset, triangles=True, reticulations=True, normalize=True):
