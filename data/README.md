...
This folder contains the biological datasets, the generated networks, the simulated sequences, python scripts and results of the simulation experiments of the paper:
